...
export const CountryItem: React.FC<CountryItemProps> = ({
  ...
  return (
    <>
      <View style={[styles.imageContainer, { height: isExplore ? 140 : 180 }]}>
        <Image
          style={[styles.box, styles.typeMd, { height: isExplore ? 140 : 180 }]}
          contentFit="cover"
          source={
            item?.image?.url
              ? { uri: item?.image?.url }
        ...
        >
          ...
          >
            <View
              style={[styles.labelItem, { marginBottom: isExplore ? 12 : 0 }]}
            >
            ...
            {!isExplore && (
              <View style={[styles.ratingLabel, { marginTop: 5 }]}>
...
const styles = StyleSheet.create({
  ...
  gradientWrapper: { flex: 1, justifyContent: "flex-end" },
  labelItem: {
    alignItems: "center",
    flexDirection: "row",
    padding: 10,
  ...
  typeMd: { height: 180, overflow: "hidden", width: 160 },
});
