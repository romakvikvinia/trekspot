...
import { CheckLiteIcon, LeftTriangle } from "../../../utilities/SvgIcons.utility";
...
export const VisitedButton = ({handleChangeActivityVisited, checkedIn, index}: VisitedButtonProps) => {
    ...
    >
      ...
      {index === 0 && !isVisitedUsed && (
        <TouchableOpacity activeOpacity={1} style={styles.calloutBox}>
          ...
          <TouchableOpacity activeOpacity={0.7} style={styles.gotItButton} onPress={() => setVisitedUsed(true)}>
