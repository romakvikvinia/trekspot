    ...
    <PaperProvider theme={theme}>
      <SafeAreaView style={{ flex: 1 }}>
        <KeyboardAvoidingView
          ...
          style={styles.screen}
        >
          {!isPreview ? <Header /> : <NormalHeader title="Activity" />}
              ...
              <View style={[styles.inputRow, styles.widthBorderBottom]}>
                ...
                {!isPreview ? (
                  ...
                  <View style={styles.inputValueWrapper}>
                    <Text style={styles.inputValue}>Barcelona vs Milan</Text>
                  </View>
                )}
              </View>
            </View>
            ...
            <View style={styles.placeSelection}>
              ...
              >
                ...
                <Text style={styles.placeSelectionButtonText}>
                  {!isPreview ? "Add address" : "Moscow avenue 9a"}
                </Text>
              </Pressable>
