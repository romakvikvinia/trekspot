...
export const TransportRoute = ({ route }) => {
  const { isPreview, type } = route?.params;
    ...
    <PaperProvider theme={theme}>
      <SafeAreaView style={{ flex: 1 }}>
        <KeyboardAvoidingView
          ...
          style={styles.screen}
        >
          {!isPreview ? <Header title={`${type} route`}/> : <NormalHeader title={`${type} route`} />}
          ...
          >
            ...
            <View style={styles.placeSelection}>
              ...
              <View style={styles.routeDate}>
                <View style={styles.routeDateLabel}>
                  ...
                  <Text style={styles.routeDateLabelText}>Departure date</Text>
                </View>
            ...
            <View style={styles.placeSelection}>
              ...
              <View style={styles.routeDate}>
                <View style={styles.routeDateLabel}>
                  <CalendarLightIcon size="20" color="#86858c" />
                  <Text style={styles.routeDateLabelText}>Arrival date</Text>
                </View>
