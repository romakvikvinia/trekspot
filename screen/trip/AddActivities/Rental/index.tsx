    ...
    <PaperProvider theme={theme}>
      <SafeAreaView style={{ flex: 1 }}>
        <KeyboardAvoidingView
          ...
          style={styles.screen}
        >
          {!isPreview ? <Header /> : <NormalHeader title="Car rental" />}
          ...
          >
              ...
              <View style={[styles.inputRow, styles.widthBorderBottom]}>
                ...
                {!isPreview ? (
                  ...
                  <View style={styles.inputValueWrapper}>
                    <Text style={styles.inputValue}>Europcar</Text>
                  </View>
                )}
              </View>
            </View>
            <View style={styles.placeSelection}>
              ...
              >
                ...
                <Text style={styles.placeSelectionButtonText}>
                  {!isPreview ? "Start address" : "Moscow avenue 9a"}
                </Text>
              </Pressable>
              ...
              <View style={styles.routeDate}>
                <View style={styles.routeDateLabel}>
                  ...
                  <Text style={styles.routeDateLabelText}>
                    {!isPreview ? "Choose date" : "Date"}
                  </Text>
                </View>
            ...
            <View style={styles.placeSelection}>
              <View style={[styles.locationInnerWrapper, styles.widthBorderBottom]}>
                <Text style={[styles.inputLabel,{flex: 1}]}>Drop-off same location</Text>
                <Switch
              ...
              >
                ...
                <Text style={styles.placeSelectionButtonText}>End address</Text>
              </Pressable>
              }
            </View>
