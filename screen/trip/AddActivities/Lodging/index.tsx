    ...
    <PaperProvider theme={theme}>
      <SafeAreaView style={{ flex: 1 }}>
        <KeyboardAvoidingView
          ...
          style={styles.screen}
        >
          {!isPreview ? <Header /> : <NormalHeader title="Lodging" />}
          ...
          >
              ...
              <View style={[styles.inputRow, styles.widthBorderBottom]}>
                ...
                {!isPreview ? (
                  ...
                  <View style={styles.inputValueWrapper}>
                    <Text style={styles.inputValue}>Crowne Plaza</Text>
                  </View>
                )}
              </View>
            </View>
            <View style={styles.placeSelection}>
              ...
              >
                ...
                <Text style={styles.placeSelectionButtonText}>
                  {!isPreview ? "Accommodation address" : "Moscow avenue 9a"}
                </Text>
              </Pressable>
              <View style={styles.routeDate}>
                <View style={styles.routeDateLabel}>
                  <CalendarLightIcon size="20" color="#86858c" />
                  <Text style={styles.routeDateLabelText}>Check-in date</Text>
                </View>
            ...
            <View style={styles.placeSelection}>
              <View style={styles.routeDate}>
                <View style={styles.routeDateLabel}>
                  <CalendarLightIcon size="20" color="#86858c" />
                  <Text style={styles.routeDateLabelText}>Check-out date</Text>
                </View>
